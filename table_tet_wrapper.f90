subroutine table_tet_wrapper (node_num, node_xyz, tetra_num, tetra_node)

  implicit none
  integer ( kind = 4 ) :: node_num
  real ( kind = 8 ), dimension(1:3*node_num), intent(in) :: node_xyz
  integer ( kind = 4 ) :: tetra_num
  integer ( kind = 4 ), dimension(1:16*node_num), intent(in) :: tetra_node

  call table_tet_Delaunay (node_num, node_xyz, tetra_num, tetra_node)

end subroutine table_tet_wrapper

subroutine table_tet_Delaunay (node_num, node_xyz, tetra_num, tetra_node)
...
!
  ...
  integer ( kind = 4 ) node_num
  real ( kind = 8 ), dimension(3:node_num), intent(in) :: node_xyz
  character ( len = 255 ) :: element_filename = ' '
  integer ( kind = 4 ) tetra_num
  integer ( kind = 4 ) tetra_num2
  integer ( kind = 4 ), dimension(4:4*node_num), intent(in) :: tetra_node
